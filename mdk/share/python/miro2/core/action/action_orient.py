...
class ActionOrient(action_types.ActionTemplate):
	...
	def start(self):
		...
		self.gaze_target_f_SENSOR = miro.lib.kc_interf.kc_viewline_to_position(
		...
		self.gaze_target_i_HEAD_OR_SENSOR = miro.lib.kc_interf.kc_viewline_to_position(
				0.0,
