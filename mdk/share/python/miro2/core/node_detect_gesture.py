...
class NodeDetectGesture(node.Node):
	...
	def detect_knee_smacking(self, palm_history, knee_x, knee_y, knee_z,
		...
		try:
			...
			# Framerate too low for reliable detection of changing knee smacking
	...
	def __init__(self, sys):
		...
		self.pub_gesture = rospy.Publisher("gesture_topic", String)
		#rospy.init_node("pub_gesture", anonymous=True)
